...
# Pre-procesing todo:
#
# Change al variables into their respected data types -   DONE
# Transform video categories iinto strings            -   DONE
# video_related_topics transformation into dummy's    -   DONE
# video duration transformation to minutes            -   DONE
# published date, remove the time                     -   DONE
# create a distance between last episode              -   DONE
