...
## What correlates with video views, number of comments, subscriber, and likes?

Table 3 presents four regresions, each with their own dependable varaible. I constructed 9 variables: video views, channel subscribers, video comments, video likes, video dislikes, video duration, video title length, days between uploads (space_between_vids), and whether a video title has a video game title (presentgametitle).

##### Table 3
![alt text](https://github.com/jjgecon/Does-Gamer-Slang-Appeal-to-Gamers/blob/master/Images/t3.png)

In column 1, the dependable variable is video views. Subscriber count, title length, video duration and days between uploads are significant. Particularly, title length and video duration are negatively correlated with video views. In other words, a long title name is correlated with videos with relatively low view count. The presence of video game titles is not correlated with views. Column 2 presents the results of a regression between channels subcribers and the other statistics. Title length is also negatively correlated with channel subscribers. Video game title are not correlated with subscriber count. Surprisingly, the duration between videos negatively correlates with subscribers while having a positive correlation with views. The duration of videos has a positive correlation with subscribers. This suggests high subscribed channels tend to have longer videos with shorted video titles.

Using the amount of video comments paints an interesting picture, depicted in column 3. The presence of video game titles is not correlated with amount of comments. Video likes and dislikes are significant but with weak. Surprisingly, the length of the title strongly correlates with comments. The dependable varaible of the last column is video likes. The relationships are similar with comments. Again, video title length has a strong correlation with likes. Short titles are more appealing to viewers, creating a larger audience. With a larger audience the number of engagement grows, given a fixed probability for someone to engage in the video. For instance, let's assume the probability to comment and like a video of is 10%. With a view count of 10 people we will have one comment. As the audience grows to 100 people the content creator will see that 10 people commented their video. 

## Discusion

There is some evidence that gaming YouTube content creators do not use game lingo in their titles. Which lead me to think three possible hypothesis. The first one, video titles, by themselves, are not that attractive to gamer viewers. The phenomenon of ["click-baiting"](https://ieeexplore.ieee.org/abstract/document/8424634) could easily reject this hypothesis, as many viewers are attracted to titles like ["Reading My Brother's Suicide Note"](https://www.youtube.com/watch?v=jIWQO4mLb9w). Second, successful YouTube channels may not need to use specific language to draw in their audience. For instanse, just mentioning the name of the game could be enough to attract views and subscribers. Nonetheless, the simple regressions doesn't seem to capture this effect. Third, gamers are not attracted by gamer words. As a result, YouTube creators use common lingo like "new" and "best" to describe their videos in the title.

That said, I cannot reject nor accept any hypothesis with this methodology and further research could provide evidence of the common words hypothesis.
...
A better research question would have been: How does click-baiting in YouTube impact the success of a popular channel? I could have used a neural network to identify click-bait titles and compare their statistics with other non-click-baiters. As an extension, one could analyze what words are predominantly used to click-bait. Nevertheless, this project made me improve my quantitative skills in web scraping and natural language processing. In my eyes, the inconclusive results were just a biproduct of learning.
